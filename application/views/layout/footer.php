<footer id="footer" class="footer">
		...
		<div class="container">
			<div class="row gy-4">
				<div class="col-lg-5 col-md-12 footer-info">
					...
					<p>Poros Sahabat Nusantara (POSNU) merupakan Lembaga yang berbadan hukum dan telah disahkan oleh Kemenkumham dalam bentuk perkumpulan.</p>
				...
				<div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
					<h4>Contact Us</h4>
					<p>
						Jl. Balai Rakyat Dalam VII/6 2<br>Rt 016/Rw 03 Kel.Tugu Selatan Koja<br>Kota Jakarta Utara<br>
	...
	<div class="container">
		<div class="copyright">
			&copy; Copyright <strong><span><a href="https://posnu.id/">POSNU</a></span></strong>.id <?= date('Y'); ?>
		</div>
		<!-- <div class="credits">
