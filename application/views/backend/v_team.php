...
<head>
    ...
    <!-- Styles -->
    <link href="<?php echo base_url() . 'assets/backend/plugins/pace-master/themes/blue/pace-theme-flash.css' ?>"
        rel="stylesheet" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/uniform/css/uniform.default.min.css' ?>"
        rel="stylesheet" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/bootstrap/css/bootstrap.min.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/fontawesome/css/font-awesome.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/line-icons/simple-line-icons.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/offcanvasmenueffects/css/menu_cornerbox.css' ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/waves/waves.min.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/switchery/switchery.min.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/3d-bold-navigation/css/style.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/slidepushmenus/css/component.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/datatables/css/jquery.datatables.min.css' ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/datatables/css/jquery.datatables_themeroller.css' ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/bootstrap-datepicker/css/datepicker3.css' ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/select2/css/select2.min.css' ?>" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/plugins/toastr/jquery.toast.min.css' ?>" rel="stylesheet"
        type="text/css" />
    <!-- Theme Styles -->
    <link href="<?php echo base_url() . 'assets/backend/css/modern.min.css' ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url() . 'assets/backend/css/themes/dark.css' ?>" class="theme-color" rel="stylesheet"
        type="text/css" />
...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                                                ...
                                                <a href="<?php echo site_url('backend/inbox'); ?>">
                                                    <div class="msg-img">
                                                        <div class="online on"></div><img class="img-circle"
                                                            src="<?php echo base_url() . 'assets/backend/images/user_blank.png'; ?>"
                                                            alt="">
                                                    </div>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic"
                                    ...
                                    <img class="img-circle avatar"
                                        src="<?php echo base_url() . 'assets/backend/images/' . $row['user_photo']; ?>"
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                    ...
                    <div class="sidebar-profile">
                        ...
                        <a href="javascript:void(0);">
                            <div class="sidebar-profile-image">
                                <img src="<?php echo base_url() . 'assets/backend/images/' . $row['user_photo']; ?>"
                        ...
                        <a href="javascript:void(0);">
                            <div class="sidebar-profile-image">
                                <img src="<?php echo base_url() . 'assets/backend/images/user_blank.png'; ?>"
                                    class="img-circle img-responsive" alt="">
                            </div>
                            <div class="sidebar-profile-details">
                                <span><?php echo $this->session->userdata('name'); ?><br>
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li><a href="<?php echo site_url('backend/testimonial'); ?>"
                            class="waves-effect waves-button"><span class="menu-icon icon-like"></span>
                            <p>Testimonials</p>
                        </a></li>
                    <li class="active"><a href="<?php echo site_url('backend/team'); ?>"
                            class="waves-effect waves-button"><span class="menu-icon icon-users"></span>
                            <p>Teams</p>
                        </a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                ...
                                                <img class="img-circle" width="50"
                                                    src="<?php echo base_url() . 'assets/backend/images/team/user_blank.jpg'; ?>">
                                                <?php else : ?>
                                                <img class="img-circle" width="50"
                                                    src="<?php echo base_url() . 'assets/backend/images/team/' . $row->team_image; ?>">
                                                <?php endif; ?>
                                            </td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="javascript:void(0);" data-toggle="modal"
                                                                data-target="#ModalEdit<?php echo $row->team_id; ?>"><span
                                                                    class="icon-pencil"></span> Edit</a></li>
                                                        <li><a href="javascript:void(0);" class="delete"
                                                                data-userid="<?php echo $row->team_id; ?>"><span
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/team/insert' ?>" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <input type="text" name="linked" class="form-control" placeholder="https://linkedin.com/"
                                        required>
                                </div>
                                <div class="form-group">
    ...
    ?>
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/team/update' ?>" method="post"
        enctype="multipart/form-data">
        <div class="modal fade" id="ModalEdit<?php echo $row->team_id; ?>" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="file" name="filefoto" class="dropify" data-height="180"
                                        data-default-file="<?php echo base_url() . 'assets/backend/images/team/' . $row->team_image; ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" name="nama" value="<?php echo $row->team_name; ?>"
                                        class="form-control" placeholder="Name" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="jabatan" value="<?php echo $row->team_org; ?>"
                                        class="form-control" placeholder="Jabatan" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="twitter" value="<?php echo $row->team_twitter; ?>"
                                        class="form-control" placeholder="https://twitter.com/" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="facebook" value="<?php echo $row->team_facebook; ?>"
                                        class="form-control" placeholder="https://facebook.com/" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="instagram" value="<?php echo $row->team_instagram; ?>"
                                        class="form-control" placeholder="https://instagram.com/" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="linked" value="<?php echo $row->team_linked; ?>"
                                        class="form-control" placeholder="https://linkedin.com/" required>
                                </div>
                                <div class="form-group">
                                    <textarea name="content" class="form-control" rows="6" placeholder="Content"
                                        disabled><?php echo $row->team_content; ?></textarea>
                                </div>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/team/delete' ?>" method="post"
        enctype="multipart/form-data">
