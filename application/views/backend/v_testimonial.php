                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                ...
                                                <?php else : ?>
                                                <img class="img-circle" width="50"
                                                    src="<?php echo base_url() . 'assets/backend/images/testi/' . $row->testimonial_image; ?>">
                                                <?php endif; ?>
                                            </td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="file" name="filefoto" class="dropify" data-height="180"
                                        data-default-file="<?php echo base_url() . 'assets/backend/images/testi/' . $row->testimonial_image; ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" name="jabatan" value="<?php echo $row->testimonial_org; ?>"
