...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="<?php echo site_url('backend/member'); ?>"
                            class="waves-effect waves-button"><span class="menu-icon icon-key"></span>
                            <p>Member</p>
                        </a></li>
                    ...
                    <li><a href="<?php echo site_url('backend/team'); ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                ...
                                                <?php else : ?>
                                                <img class="img-circle" width="50"
                                                    src="<?php echo base_url() . 'assets/backend/images/member/' . $row->member_image; ?>">
                                                <?php endif; ?>
                                            </td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="javascript:void(0);" data-toggle="modal"
                                                                data-target="#ModalEdit<?php echo $row->member_id; ?>"><span
                                                                    class="icon-pencil"></span> Edit</a></li>
                                                        <li><a href="javascript:void(0);" class="delete"
                                                                data-userid="<?php echo $row->member_id; ?>"><span
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/member/insert' ?>" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <textarea name="desc" class="form-control" rows="6" placeholder="Desc"
                                        required></textarea>
                                </div>
    ...
    ?>
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/member/update' ?>" method="post"
        enctype="multipart/form-data">
        <div class="modal fade" id="ModalEdit<?php echo $row->member_id; ?>" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="file" name="filefoto" class="dropify" data-height="180"
                                        data-default-file="<?php echo base_url() . 'assets/backend/images/member/' . $row->member_image; ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" name="nama" value="<?php echo $row->member_name; ?>"
                                        class="form-control" placeholder="Name" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="link" value="<?php echo $row->member_link; ?>"
                                        class="form-control" placeholder="Link" required>
                                </div>
                                <div class="form-group">
                                    <textarea name="desc" class="form-control" rows="6" placeholder="Deskripsi"
                                        required><?php echo $row->member_desc; ?></textarea>
                                </div>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/member/delete' ?>" method="post"
        enctype="multipart/form-data">
